...
//	- I2: check supply > previous supply
	void testSupplyAdaption() {
		...
		//AbstractComponent c2 = ConsumerFactory.generate("c2", 100, 100, 100, 100);		
		//AbstractComponent g2 = GeneratorFactory.generate("g2", 100, 90, 5, 5);
